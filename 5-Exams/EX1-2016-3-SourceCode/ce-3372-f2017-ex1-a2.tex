...
\begin{figure}[h!] %  figure placement: here, top, bottom, or page
   ...
   \label{fig:Tank}
\end{figure}
\item Figure \ref{fig:Tank} is a square (plan view) detention pond. 
The initial depth in the 1 hectare (plan view) ($L=100.0 \text{~meters}$) is $Z=3\text{~meters}$.  
What is the average outflow rate in cubic-meters-per-second, if the pond drains through the hole in the side in 24 hours?
\clearpage
