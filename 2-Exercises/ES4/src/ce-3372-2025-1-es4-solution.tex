...
\includepdf[pages={-}]{./ce_3372_es5-2017-3_solution.pdf}
\includepdf[pages={-}]{./ES4-P1.pdf}
\includepdf[pages={-}]{./ES4-P2.pdf}
\includepdf[pages={-}]{./ES4-P3.pdf}
\includepdf[pages={-}]{./ES4-P4.pdf}
\includepdf[pages={-}]{./ES4-P5.pdf}
